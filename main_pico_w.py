...
def acquisition_commande(request_file_name) :
    ...
    if "/?" in request_file_name:
        ...
        # modification  des valeurs des curseurs
        commande_split=commande.split('=')
        print(commande_split)#debug
        dico_valeurs_dynamiques[commande_split[0]] = commande_split[1]
        #print(commande_split[0]) #debug
        #print(commande_split[1])
        mtcd.traitement_commandes_dynamiques(commande_split) #traitement commandes dynamiques
